          ...
          for (var i = 1; i < 17; i++) {
            if (
              ...
              if (
                ...
                document
                  .getElementById("box" + destination)
                  .classList.add("num" + currentValue);
                document.getElementById("box" + i).innerHTML = "";
                document
                ...
                document.getElementById("box" + (destination + 1)).innerHTML ==
                ""
              ) {
                var currentValue = parseInt(
                  document.getElementById("box" + i).innerHTML
          ...
          for (var i = 5; i < 17; i++) {
            if (document.getElementById("box" + i).innerHTML != "") {
              ...
              if (
                ...
                document.getElementById("box" + (destination + 4)).innerHTML ==
                ""
              ) {
                document.getElementById(
                  "box" + (destination + 4)
