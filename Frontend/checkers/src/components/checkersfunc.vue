...
export default {
  ...
  methods: {
    ...
    checkuprightby2(itr, itr3) {
      if (this.matrix[itr - 2] && this.matrix[itr - 2][itr3 + 2]) {
        if (
          this.matrix[itr - 1][itr3 + 1].children[0].classList[1] == "black" &&
          this.matrix[itr - 2][itr3 + 2].children[0].classList[1] != "black" &&
    ...
    alertme(e, itr, itr3) {
      if (
        ...
        this.checkupright(itr, itr3);
        this.checkupright(itr - 1, itr3 - 1);
